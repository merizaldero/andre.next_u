...
$evento = [ 
    ...
    EventoManager::CAMPO_TITULO => $_POST[EventoManager::CAMPO_TITULO] ,  
    ...
    EventoManager::CAMPO_DIA_COMPLETO => $_POST[EventoManager::CAMPO_DIA_COMPLETO] 
...
$evento = $eventoManager->registrarEvento($evento);
